export const Footer = () => {
  return (
    <div className="w-[1512px] h-[318.10px] flex-col justify-start items-center inline-flex">
      <div className="self-stretch px-[136px] py-[60px] bg-zinc-700 justify-between items-center inline-flex">
      ...
      <div className="w-[1512px] px-[135px] py-6 bg-sky-300 justify-between items-center inline-flex">
